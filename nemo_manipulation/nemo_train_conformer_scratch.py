...
def main(MODEL_NAME: str, params):
    ...
    conformer_large = nemo_asr.models.EncDecCTCModel(
...
if __name__ == "__main__":
    ...
    params["model"]["train_ds"][
        "manifest_filepath"
    ] = "../data_manipulation/metadata/manifests/train-aug-manifest.json"
    params["model"]["validation_ds"][
        "manifest_filepath"
    ] = "../data_manipulation/metadata/manifests/dev-aug-manifest.json"
